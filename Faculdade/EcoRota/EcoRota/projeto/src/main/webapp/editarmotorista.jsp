...
<main>
    ...
    <form action="MotoristaServlet" method="post">
        ...
        <input type="text" id="nome" name="nome" value="<c:out value='${motorista.nome}' />" required />

        <label for="idade">Idade:</label>
        <input type="number" id="idade" name="idade" value="<c:out value='${motorista.idade}' />" min="18" required />

        <label for="matricula">Matrícula:</label>
        <input type="text" id="matricula" name="matricula" value="<c:out value='${motorista.matricula}' />" required />

        <input type="submit" value="Atualizar Motorista" />
    </form>

    <a href="MotoristaServlet?action=listar" class="back-link">← Voltar para a lista de motoristas</a>
</main>
